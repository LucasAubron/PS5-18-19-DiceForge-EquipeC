 ...
 */
public class Temple {
    private Bassin[] sanctuaire = new Bassin[10];//10 bassins
    public Temple(int nbrJoueur){
        int nbrFaceParBassin = (nbrJoueur == 2 ? 2 : 4);
        ...
        List<Face> faceBassin4 = new ArrayList<>();
        faceBassin4.add(new Face(new Ressource[][]{{new Soleil(1), new PointDeGloire(1)}}));
        faceBassin4.add(new Face(new Ressource[][]{{new Lune(1)}, {new Soleil(1)}, {new Or(1)}}));
        faceBassin4.add(new Face(new Ressource[][]{{new Lune(1), new Or(1)}}));
        faceBassin4.add(new Face(new Ressource[][]{{new Or(6)}}));
        if (nbrFaceParBassin == 2){
            faceBassin4.remove(random.nextInt(faceBassin4.size()));
            faceBassin4.remove(random.nextInt(faceBassin4.size()));
        }
        sanctuaire[4] = new Bassin(4, faceBassin4);
        ...
        List<Face> faceBassin9 = new ArrayList<>();
