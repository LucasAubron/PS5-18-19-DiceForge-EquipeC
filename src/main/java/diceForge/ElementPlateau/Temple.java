...
public class Temple {
    ...
    public Temple(int nbrJoueur){
        ...
        sanctuaire[0] = new Bassin(2, new Face(new Ressource(3, Ressource.type.OR)), nbrFaceParBassin);
        sanctuaire[1] = new Bassin(2, new Face(new Ressource(1, Ressource.type.LUNE)), nbrFaceParBassin);

        sanctuaire[2] = new Bassin(3, new Face(new Ressource(4, Ressource.type.OR)), nbrFaceParBassin);
        sanctuaire[3] = new Bassin(3, new Face(new Ressource(1, Ressource.type.SOLEIL)), nbrFaceParBassin);
        ...
        sanctuaire[5] = new Bassin(5, new Face(Face.typeFace.CHOIX, new Ressource[]{new Ressource(2, Ressource.type.PDG), new Ressource(3, Ressource.type.OR)}), nbrFaceParBassin);

        sanctuaire[6] = new Bassin(6, new Face(new Ressource(2, Ressource.type.LUNE)), nbrFaceParBassin);

        sanctuaire[7] = new Bassin(8, new Face(new Ressource(2, Ressource.type.SOLEIL)), nbrFaceParBassin);

        sanctuaire[8] = new Bassin(8, new Face(new Ressource(3, Ressource.type.PDG)), nbrFaceParBassin);
